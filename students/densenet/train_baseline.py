"""
Baseline training: DenseNet-121 on ImageNette with hard labels only.
...
def main():
    ...
    csv_path  = results_dir / "logs" / "densenet_baseline_training_log.csv"
    ckpt_path = ckpt_dir / "densenet_baseline.pth"
