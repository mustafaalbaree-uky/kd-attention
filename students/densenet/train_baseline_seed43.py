"""
Baseline training: DenseNet-121 on ImageNette - seed 43 variant.
...
the expected divergence between two models differing only by random seed.
"""
import csv
import random
import tarfile
...
def main():
    ...
    csv_path  = results_dir / "logs" / "densenet_baseline_seed43_training_log.csv"
    ckpt_path = ckpt_dir / "densenet_baseline_seed43.pth"
