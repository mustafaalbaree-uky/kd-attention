...
KD_CKPT       = _HERE / "checkpoints" / "densenet_kd.pth"
BASELINE_CKPT = _HERE / "checkpoints" / "densenet_baseline.pth"
...
def main():
    ...
    kd_student = load_densenet(KD_CKPT)
    baseline   = load_densenet(BASELINE_CKPT)
