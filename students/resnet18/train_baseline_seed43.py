"""
Baseline training: ResNet-18 on ImageNette — seed 43 variant.

Identical to train_baseline.py in every way except the random seed,
which is set to 43 (instead of 42). Used to establish a noise floor:
the expected saliency divergence between two models differing only by
random seed, against which KD alignment gains are compared.
"""
import csv
import random
import tarfile
...
def main():
    ...
    student_ckpt = ckpt_dir / "resnet18_baseline_seed43.pth"
    csv_path     = results_dir / "logs" / "resnet18_baseline_seed43_training_log.csv"
