...
Writes students/mobilenet/results/metrics/mobilenet_accuracy.csv.
"""
import csv
import random
import tarfile
...
def main():
    ...
    models_cfg = [
        ...
        ("student_kd_mobilenet",      _HERE / "checkpoints" / "mobilenet_kd.pth",       load_mobilenet),
        ("student_baseline_mobilenet",_HERE / "checkpoints" / "mobilenet_baseline.pth", load_mobilenet),
    ]

    results_dir = _HERE / "results"
    (results_dir / "metrics").mkdir(parents=True, exist_ok=True)
    csv_path = results_dir / "metrics" / "mobilenet_accuracy.csv"
