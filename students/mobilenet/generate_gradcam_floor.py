"""
Grad-CAM floor generation for MobileNetV2: seed-42 vs seed-43 baselines.
...
Run after train_baseline.py and train_baseline_seed43.py.
"""
import tarfile
...
CKPT_SEED42 = _HERE / "checkpoints" / "mobilenet_baseline.pth"
CKPT_SEED43 = _HERE / "checkpoints" / "mobilenet_baseline_seed43.pth"
...
def main():
    ...
    model_seed42 = load_mobilenet(CKPT_SEED42)
    model_seed43 = load_mobilenet(CKPT_SEED43)

    cam_seed42 = GradCAM(model=model_seed42, target_layers=[model_seed42.features[-1]])
    cam_seed43 = GradCAM(model=model_seed43, target_layers=[model_seed43.features[-1]])
